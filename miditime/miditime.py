...
class MIDITime(object):
    ...
    def add_track(self, note_list, track_name):
        self.tracks[track_name] = note_list
    ...
    def save_midi(self):
        ...
        for i, track_name in enumerate(self.tracks):
            note_list = self.tracks[track_name]
            ...
            self.MIDIFile.addTrackName(track, time, track_name)
